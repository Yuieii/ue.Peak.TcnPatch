# 2.2.0
## 修正
- PEAK 內部大改動！已更新受影響的代碼。
## 新增
- 因應 PEAK 自從 v2.0.a 開始正式支援繁體中文，目前將不會在翻譯資料中收錄未更改的文字 
  - 已新增翻譯資料的欄位（不影響格式版本）
  - 現在可以從模組設定「暫時」停用翻譯資料的文字，以快速比對官方與翻譯資料的文字
...
- 因為上述偵測是否有官方繁體中文的代碼，若有官方繁體中文就會自主停止運作，但是載入中的畫面看起來還是有 bug，所以還是來修一下了
- 因 PEAK 對繁體中文有採用專用字型，而遊戲開啟時不會自動載入，本模組已提供修正
- 因為 Thunderstore 模組審核過於麻煩，之後將會優先在 [GitHub](https://github.com/Yuieii/ue.Peak.TcnPatch/releases) 發布！
